...
nm=str(input('Bienvenido(a), ¿Cuál es tu nombre?'))
archTexto = open("proyecto.txt","r")
#Aqui esta leyendo el archivo de texto para ver los ejercicios
ejercicioesp1 = archTexto.read(839)
ejercicioesp2 = archTexto.read()
sn = "s"
#Este es el menu de eleccion
print('\n\nHola',nm,'Bienvenido(a) al programa de entrenamiento para el examen PISA\n\n')

while sn != "n":
    print("Puedes elegir de los siguientes temas cual vas a estudiar: \n")
    print("""

1)Matematicas       2)Ciencias       3)Español
...
#Esta seccion es la de mate
    ...
    if int(menu) == 1:
        ...
        if elmat in ['Seleccionar un tema','seleccionar un tema','seleccionar','selecc']:
            ...
            sn = input("Deseas seguir estudiando (s/n): ")
...
#Esta seccion es la de español        
        ...
        print("A continuacion le van a aparecer diferentes ejercicios de lectura vas a tener que responder.")
        print(ejercicioesp1)
        espa1 = input("Respuesta a la pregunta 1: ")
        if espa1 == "b" or espa1 == "B":
            print("La primer pregunta te la sacaste bien!!")
        else:
            print("Uy, te la sacaste mal.")
        espa2 = input("Respuesta a la pregunta 2: ")
        if espa2 == "a" or espa2 == "A":
            print("La segunda pregunta te la sacaste bien!!")
        else:
            print("Uy, te la sacaste mal.")
        espa3 = input("Respuesta a la pregunta 3: ")
        if espa3 == "c" or espa3 == "C":
            print("La tercer pregunta te la sacaste bien!!")
        else:
            print("Uy, te la sacaste mal.")
        espa4 = input("Respuesta a la pregunta 4: ")
        if espa4 == "a" or espa4 == "A":
            print("La cuarta pregunta te la sacaste bien!!")
        else:
            print("Uy, te la sacaste mal.")
        espa5 = input("Respuesta a la pregunta 5: ")
        if espa5 == "b" or espa5 == "B":
            print("La quinta pregunta te la sacaste bien!!")
        else:
            print("Uy, te la sacaste mal.")
        ...
        print("\n\nUsted no eligio ninguna modalidad válida, porfavor eliga otra vez.\n\n")
