...
def calcdicriminante(a,b,c):
    print("\nEstamos calculando la discriminante de su ecuacion cuadratica . . . ")
    return (b**2) - (4*a*c)
...
print("\nTomando en cuenta que la ecuacion cuadratica tiene la forma")
print("\n Ax^2 + Bx + C = 0   siendo A!= 0")
print("\nIngresa tus valores aqui\n")
a = float(input("A ==> "))
b = float(input("B ==> "))
c = float(input("C ==> "))
...
print("\nEl valor de tu discriminante es de %5.2f" %(discriminante))

if discriminante >= 0:
    x1 = calculax1(a,b)
    x2 = calculax2(a,b)
    print("\nLas raices de la ecuacion son x1 = %7.2f    y     x2 = %7.2f " %(x1,x2))
else:
